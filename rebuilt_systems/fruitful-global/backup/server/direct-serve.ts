...
export class DirectTemplateServer {
  ...
  private loadTemplates() {
    try {
      ...
      // Load YOUR actual VaultMesh business template  
      this.vaultMeshContent = readFileSync(
        join(process.cwd(), 'attached_assets/Pasted--DOCTYPE-html-html-lang-en-head-meta-charset-UTF-8-meta-name-viewport-content-1753728500303_1753728500306.txt'),
        'utf8'
      );
      console.log('✅ Loaded YOUR actual VaultMesh business template');
    } catch (error) {
