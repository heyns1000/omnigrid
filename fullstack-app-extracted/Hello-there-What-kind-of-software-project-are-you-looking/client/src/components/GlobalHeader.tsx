...
export default function GlobalHeader() {
  ...
  const navItems = [
    ...
    { path: "/sectors-portal", label: "Sectors Portal", icon: "📦" },
    { path: "/baobab", label: "Baobab™", icon: "🌳" },
    { path: "/vaultmesh-portal", label: "VaultMesh™", icon: "🔐" },
    { path: "/treaty", label: "Treaty System™", icon: "📜" },
